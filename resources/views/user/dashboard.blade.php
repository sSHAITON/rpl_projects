        ...
        <nav class="navbar navbar-expand-lg navbar-dark shadow-sm">
            <div class="container">
                <a class="navbar-brandLogo" href="#">
                    <img src="{{ asset('assets/img/logo.png') }}" alt="Logo" width="78" height="76"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="#">Catatan Kehamilan</a>
                                <a class="dropdown-item" href="#">Jadwal Check Up</a>
                                <a class="dropdown-item" href="#">Modul Kehamilan</a>
